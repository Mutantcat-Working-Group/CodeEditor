...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Mutantcat-Working-Group/CodeEditor-insiders/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Mutantcat-Working-Group/CodeEditor/releases"
fi
