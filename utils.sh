...
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-Mutantcat-Working-Group/CodeEditor}"
BINARY_NAME="${BINARY_NAME:-codeeditor}"
GH_REPO_PATH="${GH_REPO_PATH:-Mutantcat-Working-Group/CodeEditor}"
ORG_NAME="${ORG_NAME:-Mutantcat-Working-Group}"
